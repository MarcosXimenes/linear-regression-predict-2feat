...
```bash
jupyter notebook linear-regression-predict-2feat.ipynb
```

## Project Structure

```
├── linear-regression-predict-2feat.ipynb   # Main notebook
├── LICENSE                                  # MIT License
└── README.md                                # This file
```
...
**Marcos Ximenes Junior**

- [GitHub](https://github.com/MarcosXimenes)
- [LinkedIn](https://www.linkedin.com/in/marcosximenes/)
